package com.zzk.lambdademo.demo3;

import com.zzk.lambdademo.demo1.Student;
import com.zzk.lambdademo.demo2.AgeFilter;
import com.zzk.lambdademo.demo2.ObjectFilter;
import com.zzk.lambdademo.demo2.ScoreFilter;
...
public class Test {
    public static void main(String[] args) {
        ...
        getByFilter(students, new ObjectFilter<Student>() {
            @Override
